    ...
    return(
        <section className="bg-gray-100">
            <div className="container mx-auto py-16">
                <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl text-center">Features</h2>
                <ul className={'mt-[30px] list-disc text-md sm:text-lg max-w-screen-md mx-auto flex flex-col gap-y-3 pl-[20px]'}>
                    ...
                    <li>Prominent speech button to your website that lets users listen to your blog content.</li>
                    <li>Offers a seamless and user-friendly interface.</li>
                    <li>Customizable button and highlight color options</li>
                </ul>
            </div>
        </section>
    )
